...
export const ConstructionLogService = {
    async createContructionLog(data) {
        ...
        const constructionLog = await prisma.construction_log.create({
            data: {
                ...
                employees: {
                    create: await Promise.all(employeesData.map(async (employee) => {
    ...
    async getConstructionLogById(id, date) {
    ...
    async getAllConstructionLogs(projectId, userId, start_date, end_date) {
        ...
        return constructionLogs.map((log) => ({
            ...log,
            employees: log.employees?.map((emp) => ({
            ...
            equipment_usage: log.equipment_usage?.map((eq) => ({
    ...
    async updateConstructionLog(id, data) {

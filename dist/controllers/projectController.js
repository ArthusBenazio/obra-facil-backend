...
import { projectResponseSchema, projectSchema, querystringSchema, } from "../schemas/projectSchemas";
import { projectService } from "../services/projectService";
export function projectController(server) {
    server.post("/project", {
